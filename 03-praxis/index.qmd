...
Wir wenden die Erkenntnisse aus Teil 1 und 2 auf eure eigene Lehre an: Erst analysierst du deine Aufgabe mit dem 5-Fragen-Framework, dann fordert dein Partner deine Analyse als Advocatus Diaboli heraus.
...
Vergleiche dann mit dem [5-Fragen-Framework](../02-ki-und-lernen/5-fragen-framework/). Wo sind die grössten Unterschiede zwischen deiner Version und dem Original? Genau diese Stellen sind die produktivsten Lernmomente.
:::
...
**Wähle eine Aufgabe oder Prüfung aus deiner Lehre** und analysiere sie mit dem [5-Fragen-Framework](../02-ki-und-lernen/5-fragen-framework/). *Falls du keine eigene Aufgabe mitgebracht hast, nutze eines der [Fallstudien-Szenarien](./fallstudien/).*
...
- [Das 5-Fragen-Framework](../02-ki-und-lernen/5-fragen-framework/)

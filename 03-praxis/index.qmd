...
::: {.active-processing}
## Praxis: Aufgaben analysieren & Peer-Diagnose (50 Min)
...
2. **Peer-Diagnose**: Eine zweite Aufgabe analysieren und gegenseitig diagnostizieren (20 Min)

**Ziel**: Das Framework auf unterschiedliche Aufgabentypen anwenden, gegenseitig Schwachstellen diagnostizieren und mit einem konkreten Umsetzungsplan nach Hause gehen.
:::
...
**Zeitcheck:** Falls Aktivität 1 länger dauert als geplant, die SHARE-Phase auf 2 Min kürzen (1 Beispiel statt 2-3) und die Reflexionsfrage weglassen. Die THINK- und PAIR-Phasen nicht kürzen, sie sind der Kern.
:::
...
::: {.facilitator}
### Peer-Diagnose (20 Min)

Überleitung: "Ihr habt eine Aufgabe analysiert und ein Redesign vorgeschlagen. Jetzt wenden wir dasselbe Framework auf eure zweite mitgebrachte Aufgabe an und diagnostizieren gegenseitig die Schwachstellen. **Bildschirme zu, Stifte raus.** Ab jetzt arbeiten wir analog."
...
**Zeitcheck:** Falls weniger als 20 Min bleiben vor dem Closing (11:45), den Advocatus-Diaboli-Teil auf eine Runde kürzen (nur Person A stellt vor, Person B diagnostiziert, dann direkt zum 1-Satz-Redesign). Die gemeinsame Muster-&-Synthese-Phase (6 Min) kann notfalls auf 3 Min gekürzt werden, aber die individuelle Konsolidierung (5 Min) ist essenziell als Transfersicherung.
:::
...
- Wer hat festgestellt, dass die Änderung für verschiedene Studierendengruppen unterschiedlich wirkt? Das ist die **ungleiche Wirkung** aus Teil 2: Schwächer vorbereitete Studierende brauchen mehr Struktur in der Versuch-Phase. Das verdient eine eigene Vertiefung auf Departementsebene.
...
Wenn deine 5-Fragen-Analyse ergeben hat, dass eine Versuch-dann-Prüfe-Struktur mit KI-Unterstützung sinnvoll wäre, helfen dir diese Seiten bei der pädagogischen Entscheidung: Ergibt ein Agent Sinn, und wenn ja, welches Verhalten muss er zeigen?

- [Agent-Template: Analyse & Anpassung](./agent-template/) -- Entscheidungshilfe: Wann lohnt sich ein Agent, und wann nicht?

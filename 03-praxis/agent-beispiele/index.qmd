...
1. **Versuch**: Eigene Hypothesen aufstellen --- begründen, welche Biases wirken
2. **Prüfe**: Agent präsentiert widersprüchliche Evidenz oder Alternativen
3. **Ringen**: Mit Unsicherheit umgehen --- keine einfache "richtige Antwort"
...
1. **Versuch**: Ersten Entwurf schreiben --- eigene Schwächen identifizieren
2. **Prüfe**: Agent analysiert Schreibmuster (nicht Inhalt!) und stellt Fragen
3. **Überarbeiten**: Feedback in konkrete Änderungen umsetzen --- dokumentieren

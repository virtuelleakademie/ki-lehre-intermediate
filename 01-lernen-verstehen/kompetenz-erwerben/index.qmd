...
- **Vertiefung**: Der Vorhersagefehler-Mechanismus, der die Workshop-Inhalte mit wissenschaftlicher Tiefe ergänzt
- **Optional**: Grokking und Gedächtnisparadoxon als interessante Erweiterungen
...
- Wie beeinflusst das deine Aufgabengestaltung?
...
Anfängern Expertenwerkzeuge zu geben, ist nicht nur ineffektiv, sondern **aktiv schädlich** für das Lernen:
...
Du wirst diese Prinzipien in der Praxis anwenden, wenn du deine eigene Aufgabe analysierst.
:::
...
Wähle eines der vier Prinzipien (Entwicklungssequenz, kognitive Belastung, Struggle Window, Scaffolding):
...
Prediction Error Learning ist einer der wichtigsten neuronalen Mechanismen für den Kompetenzaufbau. Er erklärt, warum bestimmte didaktische Strategien (wie Abrufpraxis und Generierung) wirksam sind. Die Forschung zu Vorhersagefehlern umfasst verschiedene Systeme, darunter dopaminerge Belohnungssignale, sensorische Vorhersagefehler und Überraschung im Bayesianischen Sinne, die über unterschiedliche neuronale Substrate und Rechenprinzipien operieren. Für die Lehrpraxis ist die gemeinsame Grundidee entscheidend: *Das Gehirn lernt aus der Diskrepanz zwischen Erwartung und Erfahrung.* Daneben spielen Konsolidierung, Elaboration und Mustererkennung ebenfalls zentrale Rollen.
...
**Warum das für KI relevant ist:** Wenn ein Novize einen KI-Output liest, ist seine Likelihood-Funktion $P(d|\theta)$ *flach*, denn korrekte und inkorrekte Antworten sehen für ihn ähnlich plausibel aus. Der Informationsgewinn ist minimal. Ein Experte hingegen hat eine *scharfe* Likelihood: Er kann sofort erkennen, ob der Output zu seinem Modell passt oder nicht.

Lernen im Bayesianischen Sinne ist **Entropiereduktion**, also die Reduktion von Unsicherheit über die Struktur der Welt. Aktives Problemlösen maximiert den erwarteten Informationsgewinn, weil es die Lernenden zwingt, ihre eigenen Vorhersagen zu testen. KI-Outsourcing minimiert ihn, weil die Lernenden nie ihre eigenen Vorhersagen generieren.
:::

### Das Prinzip der "Desirable Difficulties"

Lernen erfordert sogenannte "desirable difficulties" [@bjorkMakingThingsHard2011], also Herausforderungen, die sich schwierig anfühlen, aber das langfristige Behalten fördern:
...
- Wo erwartest du den größten Widerstand von Studierenden?
...
*Schreibe den Satz auf, bevor du die Schnellreferenz-Tabellen anschaust.*
:::

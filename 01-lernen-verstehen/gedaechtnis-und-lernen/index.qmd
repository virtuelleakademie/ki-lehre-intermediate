...
4. **Abruf misst Lernen nicht bloss, er *erzeugt* es.** Das ist der wirksamste verfügbare Lernmechanismus
...
Eine zentrale Einsicht der Gedächtnisforschung: Was wir beiläufig "Gedächtnis" nennen, ist eine **Sammlung verschiedener Systeme**, die nach unterschiedlichen Regeln arbeiten, verschiedene Arten von Information speichern und unterschiedliche Implikationen für die Lehre haben.
...
Endel Tulvings **Encoding-Specificity-Prinzip** [-@tulvingEpisodicMemoryMind2002] besagt: Gedächtnisabruf ist am effektivsten, wenn der Abrufkontext mit dem Enkodierungskontext übereinstimmt. Dies ist ein gut replizierter Befund der Gedächtnisforschung, und er hat eine weitreichende Implikation für die Lehre:
...
Wenn Studierende falsche Vorstellungen mitbringen, reicht es nicht, die korrekte Erklärung zu präsentieren. Neue Information wird durch bestehende Schemata gefiltert und dabei so verarbeitet, dass sie zum bisherigen Verständnis passt. Das Missverständnis überlebt die Korrektur, wenn es nie direkt herausgefordert wird.

**Beispiel**: Ein Studierender glaubt, der p-Wert sei die Wahrscheinlichkeit, dass die Nullhypothese stimmt. Die Dozentin erklärt korrekt: "Der p-Wert ist die Wahrscheinlichkeit, diese oder extremere Daten zu beobachten, *gegeben* die Nullhypothese ist wahr." Der Studierende enkodiert das durch sein bestehendes Schema und versteht: "Also sagt p = 0.03, dass die Nullhypothese nur zu 3% stimmt." Die korrekte Definition wurde gehört, aber durch das bestehende Schema verzerrt enkodiert.
...
Ein bewährtes Prinzip für die Kursgestaltung: Jedes Thema wird nach der Vermittlung in wachsenden Abständen abgerufen.

{{< include ../../resources/figures/fig-spaced-retrieval.qmd >}}
...
Einer der folgenreichsten Befunde für die Hochschullehre [@roedigerCriticalRoleRetrieval2011]: Abruf von Information aus dem Gedächtnis misst nicht nur Lernen, er *erzeugt* Lernen.

### Der Testing Effect
Empirische Befunde legen nahe, dass die Handlung des Abrufens, also eine Frage beantworten, eine Antwort generieren, ein Problem aus dem Gedächtnis lösen, die Gedächtnisspur wirksamer verstärkt als erneutes Studieren desselben Materials [vgl. @roedigerCriticalRoleRetrieval2011; @roedigerTestenhancedLearningTaking2006].
...
: Daten basierend auf @roedigerTestenhancedLearningTaking2006. Exakte Werte variieren über Studien hinweg, aber das Muster ist robust: Das Ersetzen von Wiederlesen durch Abrufpraxis verbessert die Langzeitretention substanziell.
...
Diese Befunde verändern die Rolle von Tests in der Lehre grundlegend. Traditionelle Sicht: Tests messen, was Studierende gelernt haben. Evidenzbasierte Sicht: Tests sind ein Lernwerkzeug, und ihr Wert liegt nicht primär in der Note, sondern in der Abrufpraxis, die sie bieten.
...
Die vier Quadranten ergeben sich aus der Kombination von subjektivem Lernerleben (x-Achse) und tatsächlichem Lernerfolg (y-Achse). Produktive Anstrengung (oben links) ist das Ziel: hoher Lernerfolg bei subjektiv schwierigem Erleben. Die metakognitive Falle (unten rechts) ist das Gegenstück: Lernen fühlt sich leicht an, produziert aber wenig dauerhaftes Wissen. Der Pfeil zeigt die Gefahr der Fehleinschätzung: Wenn Leichtigkeit als Signal für Lernerfolg interpretiert wird, werden bevorzugt Strategien gewählt, die sich produktiv anfühlen, aber wenig bewirken.

### Die drei Schlüsselstrategien

#### 1. Spacing (Verteiltes Lernen)

Lerneinheiten über die Zeit verteilen statt zusammenpressen. Derselbe Zeitaufwand, aber deutlich unterschiedliche Ergebnisse.
...
Viele Standard-Lernstrategien der Studierenden sind kontraproduktiv, weil sie Vertrautheit mit Lernen verwechseln [vgl. @dunloskyImprovingStudentsLearning2013].
...
Investiere **15 Minuten** in der ersten Sitzung, um die Performance-Learning-Unterscheidung zu lehren. Zeige die Testing-Effect-Daten. Vermittle Abruf + Spacing + Interleaving. Diese einzelne Intervention kann das Lernen in den weiteren Kursen der Studierenden verbessern.
...
- Die **Versuch-dann-Prüfe-Struktur** (→ [5 Leitfragen](../../02-ki-und-lernen/5-leitfragen/)): Der Generierungseffekt erklärt, warum die Reihenfolge, *zuerst selbst denken, dann KI konsultieren*, entscheidend ist

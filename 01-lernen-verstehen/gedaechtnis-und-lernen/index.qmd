...
6. **Missverständnisse kann man nicht durch korrektes Präsentieren überschreiben**, weil Schemas neue Information still umschreiben
...
#| fig-cap: "Daten basierend auf Roediger & Karpicke (2006). Wiederholtes Testen führt zu deutlich besserer Langzeiterinnerung als wiederholtes Studieren."
#| fig-width: 9
#| fig-height: 6
#| echo: false
...
ggplot(testing_effect_data, aes(x = condition, y = retention)) +
  geom_col(aes(fill = retention), width = 0.65,
           color = brand_dark, linewidth = 0.3) +

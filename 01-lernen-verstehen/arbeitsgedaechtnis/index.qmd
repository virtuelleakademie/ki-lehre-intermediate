...
subtitle: "Warum der Flaschenhals des Lernens so viele Lehrdesign-Entscheidungen prägt"
author:
  - name: Andrew Ellis
...
2. **Vorwissen verändert den Flaschenhals**: Schemata komprimieren Elemente; die effektive Kapazität variiert mit der Expertise
...
5. **Neue Inhalte belasten fundamental anders**: Ohne Schemata fehlen alle Mechanismen, die das Arbeitsgedächtnis normalerweise entlasten
...
**Lehrimplikation**: Eine Überladung des Arbeitsgedächtnisses führt möglicherweise nicht dazu, dass Elemente einfach *verschwinden*. Stattdessen werden alle Repräsentationen *verrauschter und weniger präzise*. 
:::
...
- Für **Experten** ist dieselbe Strukturierung redundant, weil sie sie zwingt, Information zu verarbeiten, die sie bereits zu chunks verarbeitet haben
...
Das aktuelle CLT-Modell [@swellerDevelopmentCognitiveLoad2023] unterscheidet zwei Arten von Belastung:
...
Wenn extrinsische Last reduziert wird, werden Arbeitsgedächtnisressourcen frei. Diese können für **germane processing** genutzt werden: die produktive Verarbeitung, die Schemata aufbaut (Elaboration, Integration, Verknüpfung mit Vorwissen). In der älteren CLT-Literatur wurde germane processing als dritte, eigenständige Belastungsart ("germane load") behandelt. Die aktuelle Forschung sieht es präziser als den produktiven Anteil der intrinsischen Verarbeitung, nicht als separaten Belastungstyp.
...
- Die **5 Leitfragen** (→ [Teil 2](../../02-ki-und-lernen/5-leitfragen/)): Leitfrage 4 prüft, ob die kognitive Arbeit bei den Studierenden bleibt
...
- Die **Peer-Diagnose** (→ [Teil 3](../../03-praxis/)): Die Advocatus-Diaboli-Phase fordert die eigene Analyse heraus und vertieft das Verständnis

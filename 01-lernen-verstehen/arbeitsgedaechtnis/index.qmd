...
#| fig-cap: "Der Expertise Reversal Effekt: Optimale Unterstützung hängt vom Vorwissen ab. Permanentes KI-Scaffolding (gestrichelt) verhindert die Expertise-Entwicklung."
#| fig-width: 10
#| fig-height: 6
#| echo: false
...
expertise_data <- tibble(expertise = seq(0, 10, 0.5)) |>
  mutate(
  ...
  pivot_longer(
    ...
    names_to = "condition", values_to = "outcome"
  ) |>
  mutate(
    condition = factor(condition,
      levels = c("worked_examples", "problem_solving", "permanent_scaffolding"),
      labels = c("Worked Examples / Hohe Anleitung",
...
ggplot(expertise_data, aes(x = expertise, y = outcome, color = condition, linetype = condition)) +
  ...
  geom_point(
    ...
    aes(x = x, y = y), color = brand_dark,
    size = 4, shape = 21, fill = "white", stroke = 1.5, inherit.aes = FALSE
  ) +
  annotate("text", x = crossing_x + 0.3, y = crossing_y + 7,
           label = "Fading Point", size = 3.8, hjust = 0,
           fontface = "italic", family = "Lato") +
  scale_color_manual(values = c(
    "Worked Examples / Hohe Anleitung" = "#2563eb",
    "Problemlösen / Niedrige Anleitung" = "#16a34a",
    "Permanentes KI-Scaffolding" = "#dc2626"), name = NULL) +
  scale_linetype_manual(values = c(
    "Worked Examples / Hohe Anleitung" = "solid",
    "Problemlösen / Niedrige Anleitung" = "solid",
    "Permanentes KI-Scaffolding" = "dashed"), name = NULL) +
  scale_x_continuous(breaks = c(0, 5, 10),
                     labels = c("Anfänger", "Mittel", "Experte")) +
  scale_y_continuous(limits = c(20, 90), breaks = seq(20, 80, 20)) +
  labs(title = "Expertise Reversal Effekt",
       subtitle = "Optimale Unterstützung hängt vom Vorwissen ab",
       x = "Expertise-Level", y = "Lernergebnis") +
...
#| fig-cap: "Verteilung der kognitiven Belastung in drei Szenarien. Die Gesamthöhe repräsentiert die fixe Arbeitsgedächtniskapazität."
#| fig-width: 10
#| fig-height: 6
#| echo: false
...
ggplot(cognitive_load_data, aes(x = scenario, y = percentage, fill = load_type)) +
  ...
  geom_text(
    ...
    color = "white", size = 4, fontface = "bold", family = "Lato"
  ) +
  annotate("text", x = 3.45, y = 102, label = "Kapazitätsgrenze",
  ...
  labs(
    ...
    x = NULL, y = "Arbeitsgedächtniskapazität"
  ) +
  theme_minimal(base_size = 13, base_family = "Lato") +
  theme(
    plot.title = element_text(face = "bold", size = 16, color = brand_dark),

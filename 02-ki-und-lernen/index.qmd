...
**Dann (2 Min):** Vergleicht zu zweit eure Konzepte. Was habt ihr vergessen? Was war überraschend schwierig zu erinnern?
...
Präsentiere die Slides. Kernbotschaften: Offloading vs. Outsourcing, Evaluationsparadox, Lernen ≠ Leisten, "The Beach, Not the Ant", Equity, 5-Fragen-Framework. Nach den Slides kurz die 3 Sonden zeigen (Tabelle unten) und die Sonden-Aktivität durchführen, dann direkt zum Worked Example übergehen. Den Text zwischen Slides und Worked Example nicht vorlesen.
:::
...
#| echo: false
#| fig-cap: "Das Spektrum von Cognitive Offloading (lernförderlich) bis Cognitive Outsourcing (lernhinderlich), mit konkreten Beispielen."
#| fig-width: 12
#| fig-height: 6
...
Das 5-Fragen-Framework (→ Teil 3) hilft beim **Gestalten** von Aufgaben. Aber wie prüft man im Lehralltag, ob das Denken tatsächlich bei den Studierenden geblieben ist? Drei Sonden, die den Versuch-dann-Prüfe-Bogen abbilden:

| Sonde | Frage an Studierende | Was sie zeigt |
|-------|---------------------|---------------|
...
Wer outsourct, hat auf Sonde 2 keine Antwort: Es gab keine spezifischen Erwartungen, die überrascht werden konnten. Wer das Denken selbst geleistet hat, kann konkrete Überraschungsmomente benennen. → [Ausführliche Anleitung mit Beispielen](../03-praxis/5-fragen-framework/#vom-design-zur-praxis-3-sonden-für-den-lehralltag)

::: {.pair}
### Die 3 Sonden ausprobieren (1 Min)

Wähle eine der 3 Sonden. Wie würdest du sie in deiner Lehre konkret einsetzen? Formuliere eine Beispielfrage für dein Fach und tausche sie mit deinem Nachbarn aus.
:::
...
Die Herausforderungen, die wir hier beschreiben (kognitives Outsourcing, Cargo Cult Scholarship, Equity-Lücken), sind nicht neu. Sie sind die jüngste Ausprägung eines wiederkehrenden Musters: Jede Welle von Bildungstechnologie wurde von Transformationsversprechen begleitet und dann von bestehenden Praktiken domestiziert.

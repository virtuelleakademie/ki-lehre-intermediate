...
Präsentiere die Slides. Kernbotschaften: Offloading vs. Outsourcing, Evaluationsparadox, Lernen ≠ Leisten, 5 Leitfragen mit den vier Operationen (Abrufen, Generieren, Verknüpfen, Überwachen). Nach den Slides kurz die 3 Diagnose-Fragen zeigen (Tabelle unten) und die Aktivität durchführen, dann direkt zum Worked Example übergehen.
:::
...
Bevor ihr die Leitfragen auf eure eigenen Aufgaben anwendet, schauen wir uns gemeinsam an, wie eine Analyse Schritt für Schritt aussieht.
...
Eine Aufgabe, die in vielen Disziplinen vorkommt, von Sozialarbeit über Wirtschaft bis Informatik. Analysieren wir sie mit den 5 Leitfragen.

### Schritt-für-Schritt-Analyse

**Frage 1: Geht es primär ums Lernen?**

Ja, es ist eine Kursaufgabe, kein professionelles Produkt. Die Studierenden sollen lernen, Literatur zu finden, zu bewerten und zu synthetisieren. Die kognitive Arbeit muss bei den Studierenden bleiben.

**Frage 2: Welche Denkarbeit verlangt die Aufgabe?**

- **Abrufen**: Suchstrategie aus dem Gedächtnis aktivieren (welche Datenbanken? Welche Suchbegriffe?)
- **Generieren**: Eigene Bewertung jeder Quelle produzieren (relevant? Methodisch solide? Aktuell?)
- **Verknüpfen**: Mehrere Quellen zu einer Synthese integrieren, Gemeinsamkeiten und Widersprüche identifizieren
...
- **Generieren** und **Verknüpfen** werden vollständig übernommen: KI liefert fertige Zusammenfassungen und plausible Synthesen mit korrekten Zitationsformaten
- **Abrufen** wird umgangen: Studierende entwickeln keine eigene Suchstrategie
- **Überwachen** wird illusorisch: Ohne eigene Bewertungskriterien fehlt der Massstab (Evaluationsparadox)

> **Die kognitive Arbeit steckt nicht im *Produkt* (Zusammenfassungen + Synthese), sondern im *Prozess* (Suchen, Bewerten, Entscheiden). Die aktuelle Aufgabe prüft das Produkt, und genau das kann KI liefern.**

**Frage 4: Werden noch Grundlagen aufgebaut?**

Ja. Studierende lernen erst, *wie man Quellen bewertet*. Sie haben noch keine Schemata für: "Ist diese Quelle relevant? Methodisch solide? Aktuell genug?" Die identifizierten Operationen, besonders Generieren (eigene Bewertung) und Verknüpfen (Synthese), sind genau die Prozesse, die diese Schemata aufbauen.
...
1. **Operationen identifizieren**: Die Analyse beginnt nicht mit "Kann KI das?", sondern mit "Welche Denkarbeit verlangt die Aufgabe?" Das Redesign schützt gezielt die Operationen, die das Lernen tragen (Generieren, Verknüpfen), und delegiert Routineanteile (Zitationsformat)
2. **Offloading am richtigen Punkt**: KI für Zitationsformat (extrinsische Last) ist sinnvoll. KI für die Synthese (Verknüpfen) eliminiert das Lernen. Warum gerade die Synthese? Weil sie hohe **Elementinteraktivität** hat: Studierende müssen gleichzeitig mehrere Quellen, deren Argumente und die Beziehungen zwischen ihnen verarbeiten. Genau deshalb ist KI-Outsourcing hier so schädlich: Es verhindert den Aufbau der Schemata, die später die Last reduzieren würden
3. **Erst selbst, dann KI**: Die Reihenfolge entscheidet. Der eigene Versuch aktiviert Abrufen und Generieren, und der Vergleich erzeugt Verknüpfen und Überwachen. Dieses Prinzip ist theoretisch gut fundiert [vgl. @bjorkMakingThingsHard2011], aber die empirische Forschung zur spezifischen Anwendung mit KI-Tools ist noch in einem frühen Stadium

...
::: {.callout-note}
## Schritt 2: Agent erstellen & testen (15 Min)
...
- Bleibt die kognitive Anstrengung beim Lernenden?
- Wo musst du den Prompt noch anpassen?
:::
...
### Gegenseitiges Agent-Testing (10 Min)

::: {.callout-tip}
## Cross-Testing der Agents
**Person A testet Agent von Person B (5 Min):**

- Verwende den Agent für eine typische Lernsituation aus Person B's Fachbereich
- Achte auf: Fördert der Agent wirklich die gewählte Strategie?
- Notiere Prompting-Herausforderungen und Überraschungen

**Person B testet Agent von Person A (5 Min):**
...
- **Prompting-Learnings**: Welche Erkenntnisse nehmt ihr für zukünftige Agent-Entwicklung mit?
- **Make-it-Stick meets AI**: Wo funktioniert die Kombination gut, wo nicht?

**Nächste Schritte:**

- Wie könnt ihr das Gelernte in eurer Lehre einsetzen?
- Welche Tools/Plattformen wollt ihr ausprobieren?

::: {.callout-tip}
## Wichtiger Reminder
**Das Ziel war nicht, den perfekten Agent zu bauen**, sondern durch praktisches Ausprobieren zu verstehen, wie KI die wissenschaftlich bewährten Lernstrategien **unterstützen** kann - und wo die Herausforderungen beim Prompting liegen.
:::

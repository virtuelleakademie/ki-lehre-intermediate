...
Die Lernforschung zeigt: **Die Umgebung bestimmt das Verhalten** ("The Beach, Not the Ant"). Rechtliche und institutionelle Rahmenbedingungen sind Teil dieser Lernumgebung. Sie bestimmen mit, ob KI-Nutzung produktiv oder schädlich für das Lernen ist.
...
KI-Policy: Gib deutlich an, dass der Inhalt von einer KI erstellt wurde, sodass niemand dies übersehen oder missverstehen kann:
...
Zitiere das verwendete Modell in ähnlicher Weise, wie du Software zitieren würdest.

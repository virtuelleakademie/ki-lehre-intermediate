...
## 3. Verwende Beispiele und Kontext {.smaller}
...
:::{.column width="48%"}
::: {.callout-tip title="Besser"}
Erkläre, wie man eine **Marmorskulptur mit sichtbaren Rissen** restauriert. Berücksichtige:

  + Sichtung und Dokumentation des Schadens
  + Auswahl geeigneter Materialien
  + Anwendung und Glättung

Gib Details zu Werkzeugen und Techniken an.
:::
:::
::::
...
## Prompting und Lernprozess

Bessere Prompts erzeugen bessere Outputs. Aber in Lernkontexten ist die entscheidende Frage eine andere:

**Welche dieser Prompting-Techniken führt zu Offloading, und welche zu Outsourcing?**

::: {.callout-note title="Faustregel" appearance="simple"}
Wenn der Prompt die Denkarbeit an die KI delegiert, ist es Outsourcing. Wenn der Prompt die KI nutzt, um die *eigene* Denkarbeit zu vertiefen (z.B. Feedback auf einen eigenen Entwurf), ist es Offloading.
:::
